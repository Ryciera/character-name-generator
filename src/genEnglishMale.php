 ...
 */
$gender = "Male";
$tooltip = "British typically name their children after somebody they respect. The surname (" . $s1 . ") comes from the father, and the first name (" . $name . ") often comes from a grandfather.";
